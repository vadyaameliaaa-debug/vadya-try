...
<form action="<?php echo base_url()?>supplier/simpansupplier" class="formSupplier" method="POST">
 <div class="form-group mb-3">
 <label class="form-label">Kode Supplier</label>
 <input type="text" class="form-control" name="kodesupplier" placeholder="Kode Supplier">
 </div>
 ...
 <input type="text" class="form-control" name="alamatsupplier" placeholder="Alamat Supplier">
 </div>

 <div class="form-group mb-3">
 <label class="form-label">Nomor HP Supplier</label>
 <input type="text" class="form-control" name="nohpsupplier" placeholder="Nomor HP Supplier">
 </div>

 <div class="form-group mb-3">
 <label class="form-label">Email Supplier</label>
 <input type="text" class="form-control" name="emailsupplier" placeholder="Email Supplier">
 </div>
